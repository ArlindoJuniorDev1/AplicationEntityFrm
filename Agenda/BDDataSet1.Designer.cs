...
namespace Agenda.BDDataSet1TableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Nome]) VALUES (@Nome);\r\nSELECT Id, Nome FROM Clien" +
                "tes WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clientes] SET [Nome] = @Nome WHERE (([Id] = @Original_Id));\r\nSELECT" +
                " Id, Nome FROM Clientes WHERE (Id = @Id)";
        ...
        public virtual int Fill(BDDataSet1.ClientesDataTable dataTable) {
        ...
        public virtual BDDataSet1.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BDDataSet1.ClientesDataTable dataTable = new BDDataSet1.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BDDataSet1.ClientesDataTable dataTable) {
